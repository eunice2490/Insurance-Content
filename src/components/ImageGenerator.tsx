  ...
  return (
    <div className="rounded-xl border border-blue-200 bg-blue-50 p-5 space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <p className="font-semibold text-blue-900 text-sm">Generate Image with ChatGPT DALL·E 3</p>
          <p className="text-xs text-blue-600">Produce a ready-to-post image directly inside the app</p>
        </div>
      </div>
